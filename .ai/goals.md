...
| G004 | 进行中 | 修复官方社区版 Pro 授权激活超时 | 已在阿里云大陆服务器部署主授权入口，插件 `0.1.8` 已公开发布到 GitHub Release，远端 `main` 和 tag `0.1.8` 指向 `777c30e` | `npm test`、`npm run build`、`npm run package:plugin`、`npm run verify:release-assets` 已通过；还需 Obsidian 社区后台扫描 `0.1.8` |
